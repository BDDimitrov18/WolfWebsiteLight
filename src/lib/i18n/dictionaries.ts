...
const bg = {
  ...
  hero: {
    ...
    lead: "Wolf обединява поръчки, дейности и задачи, имоти и документи за собственост, фактури и отчети в една родна Windows система — с реална синхронизация между всички служители.",
