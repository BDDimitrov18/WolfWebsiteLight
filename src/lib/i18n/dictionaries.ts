...
const bg = {
  ...
  pricing: {
    ...
    cards: [
      {
        ...
        price: "€39",
        period: "/мес.",
        year: "€468/год. при годишно фактуриране",
        perpetual: "или еднократен лиценз €1 200 (+€220/год. поддръжка по избор)",
        cta: "Заявете демо",
        featured: false,
      },
      {
        ...
        price: "€99",
        period: "/мес.",
        year: "€1 188/год. при годишно фактуриране",
        perpetual: "или еднократен лиценз €3 500 (+€600/год. поддръжка по избор)",
        cta: "Заявете демо",
        featured: true,
      },
      {
        ...
        price: "€249",
        period: "/мес.",
        year: "€2 988/год. при годишно фактуриране",
        perpetual: "или еднократен лиценз €8 500 (+€1 500/год. поддръжка по избор)",
        cta: "Заявете демо",
        featured: false,
      },
      {
    ...
    notes: [
      ...
      "Алтернативен модел на потребител: €39 база + €8 на потребител месечно.",
...
const en: typeof bg = {
  ...
  pricing: {
    ...
    cards: [
      {
        ...
        price: "€39",
        period: "/mo",
        year: "€468/year, billed annually",
        perpetual: "or a one-time license €1,200 (+€220/yr optional maintenance)",
        cta: "Book a demo",
        featured: false,
      },
      {
        ...
        price: "€99",
        period: "/mo",
        year: "€1,188/year, billed annually",
        perpetual: "or a one-time license €3,500 (+€600/yr optional maintenance)",
        cta: "Book a demo",
        featured: true,
      },
      {
        ...
        price: "€249",
        period: "/mo",
        year: "€2,988/year, billed annually",
        perpetual: "or a one-time license €8,500 (+€1,500/yr optional maintenance)",
        cta: "Book a demo",
        featured: false,
      },
      {
    ...
    notes: [
      ...
      "Per-seat alternative: €39 base + €8 per user/month.",
