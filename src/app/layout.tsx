...
// Both families carry Cyrillic so Bulgarian copy renders natively.
// One superfamily (IBM Plex) in two registers: mono for headings and
// instrument labels, sans for running text.
